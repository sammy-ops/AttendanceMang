...
const Menu = ({ active, setActive }) => {
  ...
  return (
    <div className="w-64 min-h-screen flex flex-col justify-between p-4 bg-gradient-to-b from-blue-100 via-purple-100 to-pink-100 backdrop-blur-lg shadow-2xl rounded-r-3xl">
      {/* Top Profile */}
